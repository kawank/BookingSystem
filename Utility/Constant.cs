...
namespace Utility
{
    ...
    public class StoredProcedureName
    {
        ...
        // GET 
        public const string GET_EVENTS = "GetEvents";
        public const string GET_SHOW_DETAILS_FOR_BOOKING = "GetShowDetailsForBooking";
        public const string GET_SCREEN_CATEGORIES = "GetScreenCategories";
        public const string GET_MOVIES_KEY_VALUE = "GetMoviesKeyValue";
        ...
        public const string GET_MOVIES_FORHOME = "GetMoviesForHome";
        public const string GET_CINEMA_FORHOME_BYCITYID = "GetCinemaListByCityId";
        public const string GET_MOVIES_OPENINGTHISWEEK = "GetMoviesOpeningThisWeek";
        public const string GET_MOVIES_COMINGSOON = "GetMoviesComingSoon";
        public const string GET_CUSTOMER_DETAILS_BY_ID = "GetCustomerDetailsById";
        public const string GET_CUSTOMER_TRANSACTION_HISTORY = "GetCustomerTransactionHistory";
        public const string GET_INSTANT_DETAIL_BY_CINEMAID = "GetInstantDetailByCinemaId";
        
        public const string CUSTOMERLOGIN = "CustomerLogin";
        public const string VERIFYCUSTOMER = "VerifyCustomers";
        public const string FORGOTPASSWORDCUSTOMER = "ForgotPasswordCustomer";

        public const string GET_MOVIE_LIST_BY_CRITERIA = "GetMovieListByCriteria";
        public const string GET_MOVIE_SHOW_BY_ID = "GetMovieShowDetailsById";
        public const string GET_MOVIE_LIST = "GetMovieList";
        public const string GET_SHOW_LIST = "GetShowDetailsByCriteria";
        public const string GET_SHOW_LIST_BY_CINEMA_ID = "GetShowDetailsByCinemaId";
        ...
        public const string DELETE_CINEMA = "DeleteCinema";
        public const string DELETE_MOVIE = "DeleteMovie";


        // INSERT
        public const string ADD_BOOKING_INFO = "AddBookingInfo";
        public const string SAVE_EVENT = "SaveEvent";
        ...
        public const string INSERT_CUSTOMER = "InsertCustomer";


        //UPDATE
        public const string UPDATE_BOOKING_INFO = "UpdateBookingInfo";
        ...
        public const string UPDATE_CUSTOMER_PROFILE = "UpdateCustomerDetails";
        ...
        public const string IS_USER_EXISTS_BY_USER_NAME = "IsUserExistsByUserName";
        public const string CHANGECUSTOMERPASSWORD = "ChangeCustomerPassword";
    ...
    public class SessionKeys
    {
        ...
        public const string AUTHENTIC_CUSTOMER = "AuthenticCustomer";
    ...
    public class SuccessMessages
    {
        ...
        public const string DETAILS_REGISTERED = "Thank you for connecting with us. Your inputs/comments are valuable for us.";
    ...
    public class ConfigKeys
    {
        ...
        public const string NO_OF_DAYS_DISPLAYED = "NoOfDaysDisplayed";
    ...
    public class EmailTemplates
    {
        ...
        public const string CONTACT_US = "ContactUsEmail.cshtml";
    ...
    public class ToolTips
    {
        ...
        public const string PLEASE_SELECT_USER = "Please select User!";
        public const string PLEASE_ENTER_ADDRESS = "Please enter Address!";
        ...
        public const string PLEASE_SELECT_MOVIE = "Please Select Movie";
        public const string PLEASE_SELECT_DATE="Please Select Date";
